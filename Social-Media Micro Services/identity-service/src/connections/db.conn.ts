...
// import RefreshToken from '../../../identity-service/src/models/RefreshToken.model'
    ...
    await asyncRetry(
      ...
      },
      {
        ...
        onRetry: (error: any, attemptNumber: number) => {
          console.info(`Database connection failed: attempt ${attemptNumber}, error: ${error.message}, Retrying database connection...`)
        },
      },
    )
