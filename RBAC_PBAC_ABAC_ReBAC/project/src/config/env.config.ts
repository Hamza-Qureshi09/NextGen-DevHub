import { ExpiryString } from '../types/general';
...
export const EnvConfig = {
  ...
  RESOURCE_ORIGIN: process.env.RESOURCE_ORIGIN || 'http://localhost:7002',
  JWT_SECRET: process.env.JWT_SECRET!,
  JWT_EXPIRES_IN: (process.env.JWT_EXPIRES_IN as ExpiryString) || '10m',
  JWT_REXPIRES_IN: (process.env.JWT_REXPIRES_IN as ExpiryString) || '1h',
